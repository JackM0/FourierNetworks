...
class SourceSeparator:
    ...
    def PerformTransform(self):
        ...
        data_unscaled = np.copy(self.fftmag[0:2000, :, :].reshape(2000, -1))
        data_scaled = scaler.fit_transform(self.fftmag[0:2000, :, :].reshape(2000, -1))
        ...
        self.transformer_ica = FastICA(random_state=42, whiten='unit-variance', max_iter= 1000)
